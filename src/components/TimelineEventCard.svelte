...
<style>
  ...
  .event-media,.event-body{position:relative;z-index:2;pointer-events:none}.event-media{display:flex;align-items:center;justify-content:center;width:100%;height:70px;overflow:hidden;border-bottom:1px solid var(--border-subtle)}.event-media img{display:block;width:100%;height:100%;object-fit:contain}
  .event-body{display:grid;grid-template-rows:16px minmax(21px,auto) 17px minmax(48px,1fr);min-height:121px;min-width:0;padding:5px 9px 6px}.metadata{display:flex;align-items:center;min-width:0;overflow:hidden;color:var(--event-accent);font-size:10.5px;line-height:15px;font-weight:600;white-space:nowrap}.kind{display:flex;align-items:center;gap:4px;min-width:0}.kind>span,.metadata-item{overflow:hidden;text-overflow:ellipsis}.metadata-item{display:flex;align-items:center;min-width:0;color:var(--text-secondary)}.metadata-item::before{content:'·';margin:0 5px;color:var(--text-muted);flex:none}.metadata-item.rerun{color:var(--accent-warning)}.metadata-item.predicted{color:var(--text-muted)}
  ...
  .race-lines{display:grid;min-width:0;width:100%;order:0;gap:0}.race-lines span{font-size:10px;line-height:13px;color:var(--text-secondary);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.race-lines span:first-child{color:var(--text-primary);font-weight:600}.has-race .event-body{min-height:145px;grid-template-rows:16px minmax(21px,auto) 19px minmax(72px,1fr)}.has-race .event-footer{gap:1px}.has-race .rewards{flex-basis:100%;padding-top:3px;border-top:1px solid var(--border-subtle);font-size:10px}.has-race .reward-item img{width:20px;height:20px}
  ...
  .is-mobile .metadata{font-size:9px}.is-mobile.no-pickups:not(.has-race) .event-body{min-height:101px;grid-template-rows:15px minmax(18px,auto) 17px minmax(32px,1fr)}
