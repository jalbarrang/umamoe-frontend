...
<style>
  ...
  @media (max-width:767px) {.best-list button{min-height:var(--touch-target)}.best-fits header :global(.icon-button){width:var(--touch-target);height:var(--touch-target)}.best-fits header{padding-block:0}}
  @media (max-width:767px) {.node-actions :global(.icon-button),.empty-actions>:global(.icon-button),.entry-label>:global(.icon-button),footer :global(.ui-button){min-width:var(--touch-target);min-height:var(--touch-target)}.entry-label :global(input){height:var(--touch-target)}.manual-tree{padding:10px}.manual-node.filled{padding:10px}.identity-copy{min-width:100px}.empty-node{padding:10px;gap:8px}}
