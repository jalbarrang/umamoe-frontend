...
<style>
  ...
  @media (max-width:600px) {.search{min-height:var(--touch-target);padding-block:0;padding-right:0}.clear-search{width:var(--touch-target);height:var(--touch-target);flex-basis:44px}}
