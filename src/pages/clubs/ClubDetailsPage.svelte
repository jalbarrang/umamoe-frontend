...
<style>
  ...
  .member-stats { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:4px 16px; padding-top:6px; border-top:1px solid var(--border-subtle); }.member-stats>div { display:flex; flex-wrap:wrap; align-items:baseline; align-content:start; justify-content:space-between; gap:2px 4px; min-width:0; }.member-stats dt { color:var(--text-muted); font-size:10px; }.member-stats dd { margin-left:auto; max-width:100%; font-size:11px; font-weight:600; line-height:1.4; font-variant-numeric:tabular-nums; white-space:nowrap; }
