...
<style>
  ...
  .rule-join { justify-self:end; }.rule-join :global(.segments) { padding:2px; }.rule-join :global(.segments button) { min-height:24px; padding:0 8px; font-size:10px; }
