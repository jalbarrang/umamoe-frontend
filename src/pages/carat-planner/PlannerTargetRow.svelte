...
<style>
  ...
  .step-progress{min-width:0;width:320px;max-width:100%}.step-progress :global(.field>label){font-size:10px}.step-goal{display:flex;align-items:end;gap:12px;flex-wrap:wrap}.step-goal :global(.field){max-width:240px}.step-goal>strong{padding-bottom:9px;color:var(--accent-primary);font:inherit;font-weight:600;font-variant-numeric:tabular-nums}
  .step-up-summary{grid-column:1/-1;display:grid;gap:6px;padding:10px;border-top:1px solid var(--border-subtle);font-family:var(--font-sans);font-size:12px}.step-up-summary ol{margin:0;padding-left:20px;display:grid;gap:4px}.step-up-summary small{color:var(--text-secondary)}
