...
<style>
  ...
  .goal-workspace{min-width:0;display:grid;grid-template-columns:minmax(360px,.8fr) minmax(0,1.2fr);border-top:1px solid var(--border-subtle)}
  ...
  @media(max-width:1100px){.goal-workspace{grid-template-columns:minmax(340px,.85fr) minmax(0,1.15fr)}.outcome-legend{grid-template-columns:repeat(2,minmax(0,1fr))}}
