...
export const previews: Preview[] = [
  ...
  { id: 'identity', title: 'Skills, sparks & stats', library: 'uma', group: 'Game displays', components: ['components/SkillChip.svelte', 'components/SparkRow.svelte', 'components/RankBadge.svelte', 'components/AptitudeGrid.svelte', 'components/StatStrip.svelte'], route: '/veterans' },
