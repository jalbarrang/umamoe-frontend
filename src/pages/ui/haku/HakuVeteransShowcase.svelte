...
<section id="haku-veterans" class="haku-group">
  ...
  <div class="haku-contract-grid">
    ...
    <div class="wide"><HakuContract id="haku-race-planner" title="Race schedule" source="src/components/RaceSchedule.svelte" origin="uma" note="Canonical uma.moe race planner"><RaceSchedule years={raceYears}/></HakuContract></div>
