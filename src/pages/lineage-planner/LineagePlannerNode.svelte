...
<style>
  ...
  .node-toolbar{width:100%;display:flex;align-items:center;flex-wrap:wrap;gap:6px;padding-top:8px;border-top:1px solid var(--border-subtle)}.spark-affinity,.breakdown,.breakdown>span{display:inline-flex;align-items:center;gap:4px;font-size:10px}.spark-affinity{color:var(--accent-purple)}.spark-affinity b{font-size:13px}.spark-affinity small{color:var(--text-muted);font-size:10px}.breakdown{color:var(--text-muted)}.base{color:var(--accent-pink)}.race{color:var(--accent-warning)}.race-action{margin-left:auto;display:flex;align-items:center;gap:6px}.race-action :global(.ui-button){min-height:28px;padding:2px 4px;font-size:10px}
  .sparks{display:flex;flex-wrap:wrap;gap:5px;align-content:start;min-width:0}.sparks>:global(.spark){font-size:11px;min-width:0}.sparks>small{color:var(--text-muted);font-size:11px}
