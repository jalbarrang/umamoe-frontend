    ...
    {#if node.layer > 0 && node.layer < 3}
      <section class="sparks" aria-label={`Sparks for ${node.label}`}>
        <header class="node-toolbar">
          {#if breakdown}<div class="affinity-breakdown" role="group" aria-label="Spark affinity breakdown" title={`Spark affinity ${affinity}: ${breakdown.base} base + ${breakdown.race} race`}><span class="spark-affinity"><strong>{affinity}</strong><Icon name="star" size={12}/></span><span>=</span><span class="base"><b>{breakdown.base}</b> Base</span><span>+</span><span class="race"><b>{breakdown.race}</b> Race</span></div>{/if}
...
<style>
  ...
  .node{min-width:0;width:100%;display:flex;flex-direction:column;gap:8px;align-self:stretch;padding:8px;border:1px solid var(--border-primary);border-radius:var(--radius-md);background:var(--surface-1);box-sizing:border-box}.node.layer-0{border-color:rgb(var(--accent-primary-rgb)/.35)}.node.active,.node:focus-within{position:relative;z-index:2;border-color:var(--color-accent)}
  ...
  .node-actions,.empty-actions{display:flex;align-items:center;flex-wrap:wrap;gap:6px}.node-actions :global(.ui-button),.empty-actions :global(.ui-button){height:32px;min-height:32px;padding:0 8px;font-size:11px}.node-actions :global(.icon-button){width:32px;height:32px;min-height:32px;margin-left:auto}.node-actions :global(svg){width:14px;height:14px}.empty-actions :global(.ui-button:first-child){border-color:rgb(var(--accent-primary-rgb)/.35);color:var(--color-accent)}.layer-0 .empty-actions :global(.ui-button:first-child){color:var(--button-primary-text)}
  ...
  .composition{display:flex;align-items:center;flex-wrap:wrap;gap:5px;padding-top:10px;border-top:1px solid var(--border-subtle);font-size:11px;color:var(--text-muted)}.composition-label{flex-basis:100%;font-size:10px}.term{padding:3px 5px;border-radius:4px;background:var(--color-accent-soft);color:var(--color-accent)}.term.shared{background:rgb(129 199 132/.1);color:var(--accent-success)}.composition>strong{color:var(--accent-pink)}
   .node-toolbar{width:100%;display:flex;align-items:center;gap:6px;padding:5px 0 2px;border-top:1px solid var(--border-subtle)}
   .affinity-breakdown{display:flex;align-items:center;gap:4px;flex:none;color:var(--text-muted);font-size:10px;white-space:nowrap;font-variant-numeric:tabular-nums}.spark-affinity{display:flex;align-items:center;gap:3px;color:var(--accent-purple)}.spark-affinity strong{font-size:14px;line-height:1}.base b{color:var(--accent-pink)}.race b{color:var(--accent-warning)}.race-action{margin-left:auto;display:flex;align-items:center;gap:4px;white-space:nowrap}.race-action :global(.ui-button){height:32px;min-height:32px;padding:0 7px;font-size:11px}
   .sparks{display:flex;flex-wrap:wrap;gap:2px 3px;align-items:flex-start;align-content:start;min-width:0}.sparks>:global(.spark){font-size:11px;min-width:0}.sparks>small{color:var(--text-muted);font-size:11px}.sparks :global(.spark-add-control>.ui-button){height:28px;min-height:28px;padding-block:0}
  @container lineage-node (max-width:480px){
    .node-heading:has(.node-main){gap:6px}.node-actions{flex:none;flex-wrap:nowrap;gap:4px}.node-actions .action-label{display:none}.node-actions :global(.ui-button){width:32px;min-width:32px;padding:0;gap:0}.node-actions :global(.icon-button){min-width:32px}.node-main{gap:6px}.node-main img,.layer-0 .node-main img,.avatar{width:32px;height:40px}.name-row>strong{font-size:12px;white-space:nowrap}.copy .source{font-size:9px}.total{font-size:14px;gap:2px}.race-action :global(.ui-button){padding:0 4px;font-size:10px;gap:3px;min-width:0}.race-action :global(svg){width:12px;height:12px}.race-label{display:none}
  }
  @container lineage-node (max-width:300px){.affinity-breakdown{gap:3px;font-size:9px}.spark-affinity{gap:2px}.spark-affinity strong{font-size:12px}}
</style>
