...
<style>
  ...
  @media(pointer: coarse) and (max-width: 1300px),(max-width:767px){.node-actions :global(.ui-button),.empty-actions :global(.ui-button),.sparks header :global(.ui-button),.race-action :global(.ui-button){min-height:44px}.node-actions :global(.icon-button),.spark-line :global(.icon-button){min-width:44px;min-height:44px}}
</style>
