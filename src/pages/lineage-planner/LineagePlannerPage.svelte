...
<style>
  ...
  .planner-shell{container:lineage-planner / inline-size}.parent-branch{container:lineage-branch / inline-size}
  ...
  @container lineage-planner (max-width:1040px){.parents{grid-template-columns:1fr;gap:24px}.parent-branch{grid-template-rows:auto;grid-row:auto}.branch-heading::before{display:none}.branch-affinity{display:flex}.parent-connections{height:60px}.parent-connections::before{height:40px}.parent-connections::after,.parent-flow{display:none}.shared-flow{top:18px}}
  @container lineage-branch (max-width:620px){.grandparents{grid-template-columns:1fr;padding:24px 0 0 44px;gap:16px}.grandparents::before{left:0;top:0;height:52px}.grandparents::after{left:0;right:50%;top:0}.gp-branch::before{left:-44px;top:28px;width:44px;height:0;border-left:0;border-top:1px solid var(--flow-line)}.gp-branch:not(:last-child)::after{content:'';position:absolute;left:-44px;top:28px;bottom:-44px;border-left:1px solid var(--flow-line)}.gp-flow{left:-22px;top:18px;gap:3px;padding:2px;font-size:10px}.gp-flow>span{display:none}}
