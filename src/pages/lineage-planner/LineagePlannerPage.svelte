...
<style>
  ...
  @container lineage-planner (max-width:1040px){.parents{grid-template-columns:1fr;gap:24px}.parent-branch{grid-template-rows:auto;grid-row:auto}.grandparents{grid-row:auto;grid-template-rows:auto auto auto}.branch-heading::before{display:none}.branch-affinity{display:flex}.parent-connections{height:60px}.parent-connections::before{height:40px}.parent-connections::after,.parent-flow{display:none}.shared-flow{top:18px}}
  @container lineage-planner (1040px < width <= 1252px) or (width <= 620px){.grandparents{grid-template-columns:1fr;padding:40px 0 0 14px}.gp-branch+.gp-branch{margin-top:26px}.grandparents::before{left:0;top:16px;height:10px}.grandparents::after{left:0;right:50%;top:0;height:16px;border-top:0;border-right:1px solid var(--flow-line);border-bottom:1px solid var(--flow-line)}.gp-branch::before{left:-14px;top:-14px;width:26px;height:0;border-left:0;border-top:1px solid var(--flow-line)}.gp-branch:not(:last-child)::after{content:'';position:absolute;left:-14px;top:-14px;bottom:-18px;border-left:1px solid var(--flow-line)}.gp-flow{left:12px;top:-25px;transform:none}.gp-flow>span{display:none}}
