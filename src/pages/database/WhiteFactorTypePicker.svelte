...
<style>
  ...
  @media (max-width:767px) {.browse-families button,.browse-subtype :global(.select-control),.browse-mode .factor-result{min-height:var(--touch-target)}}
  @media (max-width:767px) {.effect-button,.clear-button{width:var(--touch-target);height:var(--touch-target);flex-basis:44px}.factor-search{min-height:var(--touch-target)}}
</style>
