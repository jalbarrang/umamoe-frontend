import englishTimelineImagePathsJson from '../../src/assets/timeline-images/en/manifest.json';
import japaneseTimelineImagePathsJson from '../../src/assets/timeline-images/jp/manifest.json';
...
const artwork: Record<string, string> = import.meta.env.DEV
  ? Object.fromEntries(Object.keys(import.meta.glob('../../src/assets/timeline-images/**/*.webp')).map(path => [path, path.replace('../../', '/')]))
