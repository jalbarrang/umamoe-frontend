import type { RaceBadgeData, RaceGrade, RaceScheduleYear } from '../ui/race-types';
...
async function raceMappings(): Promise<RaceMapping[]> {
  catalogPromise ??= import('../../src/data/race_to_saddle_mapping.json').then((module) => ((module.default as { races?: RaceMapping[] }).races ?? []));
