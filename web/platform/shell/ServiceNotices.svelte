<script lang="ts">
  ...
  import { availableVersion, reloadUpdatedVersion, startSiteServices, CURRENT_UPDATE_VERSION } from '../site-services';
  import { browserProofPort, browserVerification } from '../http/browser-proof';
  import type { RateLimitNotice } from '../http/http-client';
