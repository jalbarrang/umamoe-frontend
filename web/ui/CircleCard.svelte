<script lang="ts">
  ...
  import { clubRankIcon, clubPolicyLabels as policyLabels } from '../domain/clubs/club-display';
...
<style>
  ...
  .row{padding:8px 14px}.row .card-header{display:grid;grid-template-columns:54px 44px minmax(0,1fr) auto 20px;gap:12px;align-items:center}
  .row .rank-section{grid-column:1;grid-row:1;min-width:0}.row .club-rank-icon{grid-column:2;grid-row:1}.row .circle-info{grid-column:3;grid-row:1}.row .fans-section{grid-column:4;grid-row:1}.row .actions{grid-column:5;grid-row:1}.row .card-header:not(:has(.club-rank-icon)){grid-template-columns:auto 0 minmax(0,1fr) auto 16px}.row .rank-main{flex-direction:column;gap:4px}.row .rank-number{max-width:100%;overflow-wrap:anywhere;font-size:20px}.row .rank-diff{font-size:11px}.row .rank-diff :global(svg){width:14px;height:14px}.row .yesterday-rank{display:none}
  ...
  @media(max-width:1100px){.row .card-header{grid-template-columns:42px 36px minmax(0,1fr) auto 16px;gap:10px}.row .club-rank-icon img{width:36px;height:36px}.row .fans-count{font-size:15px}}
  @media(max-width:520px){
    .row{padding:8px 10px}.row .card-header{grid-template-columns:40px 30px minmax(0,1fr) auto 12px;gap:6px}.row .rank-number{font-size:16px}.row .club-rank-icon img{width:30px;height:30px}.row .circle-name{font-size:13px}.row .club-meta-line{gap:4px}.row .circle-meta{font-size:10px}.row .join-style,.row .policy-badge{font-size:9px;padding-inline:4px}
