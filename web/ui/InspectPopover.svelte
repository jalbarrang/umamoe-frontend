...
<style>
  ...
  @media (pointer: coarse) { .trigger { min-width: var(--touch-target); min-height: var(--touch-target); }.close { width: var(--touch-target); height: var(--touch-target); top: 0; right: 0; }.popover { padding: var(--inspect-popover-padding, 12px 48px 12px 12px); } }
</style>
