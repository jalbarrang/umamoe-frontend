<script lang="ts">
  ...
  import { loadSkillCatalog, type SkillCatalogEntry } from '../../catalog/skill-catalog';
  import { aptitudeGrade, groupStadiumMembers, runningStyleName, scenarioName, totalStats } from '../../domain/profile/profile-display';
  import type { AptitudeItem } from '../../ui/AptitudeGrid.svelte';
