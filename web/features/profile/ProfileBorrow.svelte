<script lang="ts">
  ...
  import InheritanceResultCard from '../database/InheritanceResultCard.svelte';
  import { queueBorrowView, trackBorrowCopy } from '../database/borrow-interactions';
  ...
  import { profileInheritanceRecord } from '../../domain/profile/profile-display';
