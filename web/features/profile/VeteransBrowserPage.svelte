<script lang="ts">
  ...
  import { loadCharacterCatalog, type CharacterCatalogEntry } from '../../catalog/character-catalog';
  import { mergeVeterans, veteranProfile } from '../../domain/veterans/veteran-profile';
  import { draftScope, veteranDrafts, veteranLibraryRevision } from '../veterans/veteran-library';
  import { profileRepository, type ProfileResponse, type TrainerProfile } from './profile-repository';
