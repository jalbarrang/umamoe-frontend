<script lang="ts">
  ...
  import { characterImagePath, loadCharacterCatalog, type CharacterCatalogEntry } from '../../catalog/character-catalog';
  ...
  import { formatProfileNumber as format } from '../../domain/profile/profile-display';
