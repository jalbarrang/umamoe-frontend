<script lang="ts">
  ...
  import { encodedSkills, veteranBaseStat, veteranFactorTotals, type VeteranFactorFilter, type ResolvedVeteranFactor } from '../../domain/profile/profile-veterans';
  import { resolveEncodedSkill, skillPointTotal, skillImage, skillRarity, sortEncodedSkills, type SkillCatalogEntry } from '../../catalog/skill-catalog';
  ...
  import type { VeteranQueryMatch } from '../../domain/profile/profile-veteran-query';
