<script lang="ts">
  ...
  import { loadSupportCardCatalog, supportCardImagePath, type SupportCardCatalogEntry } from '../../catalog/support-card-catalog';
  import { supportTypeName } from '../../domain/supports/support-card';
  import { veteranSupportCards } from '../../domain/veterans/veteran-profile';
  ...
  import type { RaceHistoryEntry } from '../../catalog/race-catalog';
  import { encodedSkills, resolveVeteranFactors, veteranFactorTotals } from '../../domain/profile/profile-veterans';
  import { resolveEncodedSkill, skillImage, skillRarity, skillPointTotal, sortEncodedSkills, type SkillCatalogEntry } from '../../catalog/skill-catalog';
