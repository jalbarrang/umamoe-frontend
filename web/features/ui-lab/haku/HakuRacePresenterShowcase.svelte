<script lang="ts">
  ...
  import skillSpeed from '../fixtures/skill-speed.webp';
  import skillRecovery from '../fixtures/skill-recovery.webp';
  import supportSpeed from '../fixtures/support-card-speed.webp';
  import supportStamina from '../fixtures/support-card-stamina.webp';
  import supportPower from '../fixtures/support-card-power.webp';
