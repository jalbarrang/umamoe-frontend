<script lang="ts">
  import type { CaratPlan, PlannerRewardResource } from '../../domain/timeline/carat-planner';
  import { cycleRewardOption, rewardBannerPlanned, rewardGroupActive, rewardGroupSelectable, updateRewardGroup, type PlannerRewardGroup } from '../../domain/timeline/planner-reward-groups';
  import { activateRewardEvents, campaignState, selectPlannerCampaign, type PlannerCampaign } from '../../domain/timeline/planner-campaigns';
