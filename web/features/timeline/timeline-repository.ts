import { contentUrl } from '../../platform/content-html';
import { loadCharacterNames } from '../../catalog/character-catalog';
import { loadSupportCardCatalog } from '../../catalog/support-card-catalog';
import { timelineImage } from '../../catalog/timeline-artwork';
import { timelinePickups, type TimelinePickupCatalog } from '../../domain/timeline/timeline-pickups';
import { parseResourceDate, toTimelineCalculation, toTimelinePrediction, type TimelinePrediction } from '../../domain/timeline/timeline-prediction-types';
import { resourceRepository } from '../../catalog/resource-repository';
import type { TimelineEventData } from '../../ui/timeline-types';
import { compareTimelineEvents, type TimelineAnniversary } from '../../domain/timeline/timeline-layout';
