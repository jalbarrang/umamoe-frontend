<script lang="ts">
  import type { CaratPlan, PlannerCompetitiveRewardVariant, PlannerCurrency, PlannerGlobalRewardComparison, PlannerIncomeCadence, PlannerIncomeRule, PlannerRewardEntry } from '../../domain/timeline/carat-planner';
  import { applyIncomePreset, applyScenarioSelection, PLANNER_INCOME_PRESETS, scenarioSelectionToEnable } from '../../domain/timeline/planner-income-presets';
  import { isLegacyTrainingPassIncomeRule } from '../../domain/timeline/planner-income-assumptions';
