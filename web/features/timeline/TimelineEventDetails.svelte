<script lang="ts">
  ...
  import { contentUrl, sanitizeContentHtml } from '../../platform/content-html';
  import { buildTimelinePrediction } from '../../domain/timeline/timeline-prediction';
  import type { TimelineCalculation } from '../../domain/timeline/timeline-prediction-types';
  import { timelineRaceEventFacts } from '../../domain/timeline/timeline-race-facts';
  import { timelineDisplayTitle, timelinePickup, type TimelinePickupCatalog } from '../../domain/timeline/timeline-pickups';
  import type { PlannerGachaEntry } from '../../domain/timeline/carat-planner';
  import type { TimelineRewardItem, TimelineRewardSummary } from '../../domain/timeline/timeline-reward-summary';
