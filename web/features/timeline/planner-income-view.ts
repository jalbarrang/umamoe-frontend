import type { CaratPlan, PlannerCurrency, PlannerGlobalRewardComparison, PlannerIncomeRule, PlannerCompetitiveRewardVariant } from '../../domain/timeline/carat-planner';
import { incomeRuleScenarioSelectionMatches, isLegacyTrainingPassIncomeRule, randomGameplayIncomeRules, resolveTrainingPassStartDate, trainingPassIncomeRules, RANDOM_GAMEPLAY_INCOME_OPTIONS, TRAINING_PASS_OPTIONS } from '../../domain/timeline/planner-income-assumptions';
import { buildDataDrivenCompetitionOptions, COMPETITION_GROUPS, resolveDataDrivenCompetitionOption } from '../../domain/timeline/planner-competition-assumptions';
import type { TimelineRecord } from './timeline-repository';
import type { IconName } from '../../ui/icon-types';
import { clubRankIcon } from '../../domain/clubs/club-display';
