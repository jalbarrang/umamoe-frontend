<script lang="ts">
  import { buildTimelineRewardSummaries, withTimelineRewardFallbacks } from '../../domain/timeline/timeline-reward-summary';
  import { copyText } from '../../platform/clipboard';
  import { itemIconPath } from '../../catalog/item-icons';
  import { onMount, untrack } from 'svelte';
  import { searchParams } from 'sv-router';
  import type { TimelineRecord } from './timeline-repository';
  import { activePlan, availableCrystals, clonePlanCollection, createPlan, enabledPlannerTargets, findPlannerEvent, importPlanCollection, importSharedPlan, withoutPlannerResourceDates, plannerTargetEvents, sanitizePlan, synchronizePlannerTargets, projectPlan, setTimelineEvent, type CaratPlan, type CaratPlanCollection, type PlannerDataBundle, type PlannerTarget } from '../../domain/timeline/carat-planner';
  import { compactPlannerCollectionResourceState } from '../../domain/timeline/planner-resource-state';
  import { reconcileIncomePreset } from '../../domain/timeline/planner-income-presets';
  import { activeIncomeAssumptionCount, buildPlannerIncomeGroups, enabledIncomeTotalLabel } from './planner-income-view';
  import { buildPlannerRewardGroups, plannerRewardSummary } from '../../domain/timeline/planner-reward-groups';
  import { buildPlannerCampaigns } from '../../domain/timeline/planner-campaigns';
  import { filterPlannerBanners, plannerPullPlanItems } from '../../domain/timeline/planner-presentation';
  import { timelineDisplayTitle, type TimelinePickupCatalog } from '../../domain/timeline/timeline-pickups';
  import { decodeCompactPlannerShare, encodeCompactPlannerShare } from '../../domain/timeline/planner-share-codec';
