import type { PlannerDataBundle, PlannerGachaEvent, PlannerGachaEntry, PlannerGachaResource, PlannerIncomeResource, PlannerRewardResource, PlannerCoreResource } from '../../domain/timeline/carat-planner';
import { resolvePlannerGachaRates } from '../../domain/timeline/planner-gacha-rates';
import { applyGlobalRewardPrecedence } from '../../domain/timeline/planner-reward-precedence';
import { QueryCache } from '../../platform/data/query-cache';
import { appHttp } from '../../platform/http/app-http';
import { loadSupportCardRarities } from '../../catalog/support-card-catalog';
import { parseJsonResponse } from '../../catalog/json-asset';
