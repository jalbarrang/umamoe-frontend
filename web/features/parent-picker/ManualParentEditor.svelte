<script lang="ts">
  ...
  import { manualBestFits, type ManualParent } from '../../domain/veterans/parent-picker';
  import type { VeteranAffinityEngine } from '../../domain/veterans/affinity-engine';
...
<style>
  ...
  .sparks-editor{margin-top:4px;padding-top:8px;border-top:1px solid var(--border-subtle)}.node-sparks{display:flex;flex-wrap:wrap;gap:4px;margin-bottom:6px}.node-sparks:empty{display:none}.node-sparks :global(.spark){min-width:0;gap:.15rem;padding:.15rem .4rem;font-size:.65rem;line-height:1.5;background:rgb(var(--spark-rgb)/.1);border-color:rgb(var(--spark-rgb)/.35)}.node-sparks :global(.name){max-width:100px;line-height:1.5}.node-sparks :global(.level){font-weight:700;line-height:1.5}.tagline small{line-height:1.5}
  ...
  @media(max-width:767px),(pointer:coarse){.best-list button{min-height:var(--touch-target)}.best-fits header :global(.icon-button){width:var(--touch-target);height:var(--touch-target)}.best-fits header{padding-block:0}}
  @media(max-width:767px),(pointer:coarse){.node-actions :global(.icon-button),.empty-actions>:global(.icon-button),.entry-label>:global(.icon-button),footer :global(.ui-button){min-width:var(--touch-target);min-height:var(--touch-target)}.entry-label :global(input){height:var(--touch-target)}.manual-tree{padding:10px}.manual-node.filled{padding:10px}.identity-copy{min-width:100px}.empty-node{padding:10px;gap:8px}}
