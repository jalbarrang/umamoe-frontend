<script lang="ts">
  ...
  import LimitBreak from '../../ui/LimitBreak.svelte';
  import RankBadge from '../../ui/RankBadge.svelte';
  import SparkItem, { type SparkTone } from '../../ui/SparkItem.svelte';
  import { inheritanceAffinity, inheritanceFactors, inheritanceFactorMatched, type InheritanceFactor } from '../../domain/inheritance/inheritance-factors';
  import { sparkMetrics } from '../../domain/inheritance/spark-probability';
  import { scenarios } from '../../catalog/scenario-catalog';
  ...
  import type { InheritanceRecord, InheritanceSearchFilters } from '../../domain/inheritance/inheritance-search';
  import type { CatalogEntry } from './catalog-repository';
  import { loadOptimalRaceRecommendations, type OptimalRaceRecommendation } from '../../catalog/race-catalog';
