<script lang="ts">
  ...
  import { factorImage, factorOptions, type FactorCategory } from '../../catalog/factor-catalog';
  import type { FactorRequirement } from '../../domain/inheritance/inheritance-search';
  import WhiteFactorTypePicker from './WhiteFactorTypePicker.svelte';
  import { completeTourInteraction } from '../../platform/tours/tour-state';
