<script lang="ts">
  ...
  import { loadRaceHistory, raceHistorySchedule, type RaceHistoryEntry } from '../../catalog/race-catalog';
...
<style>
  ...
  @media(pointer:coarse){.view-toggle button,.export{min-width:var(--touch-target);min-height:var(--touch-target)}}
</style>
