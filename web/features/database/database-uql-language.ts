import {
  ...
  scopedUqlFactors,
} from '../../domain/inheritance/uql-fields';
import { factorOptions, factorImage } from '../../catalog/factor-catalog';
import { characterImagePath } from '../../catalog/character-catalog';
import type {
  UqlSuggestion,
  UqlValueContext,
  UqlFieldType,
} from '../../ui/query-editor-types';
import { UqlEditorLanguage } from '../../domain/inheritance/uql-editor';
import type { CatalogEntry } from './catalog-repository';
import type { RaceQueryValue } from '../../catalog/race-catalog';
import type { UqlCharacter } from '../../domain/inheritance/uql-compiler';
import { uqlLegacyDisplay, uqlLegacyName } from '../../domain/inheritance/uql-context';
