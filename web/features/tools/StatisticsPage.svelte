<script lang="ts">
  ...
  import { aggregateMetric, aggregateStatDistributions, characterScopes, characterUsage, meanStats, statisticsDistanceId, supportTypeDistribution, compositionLabel, histogram, metricMaps, type ChartDatum, type StatisticsFilters } from '../../domain/statistics/statistics';
  ...
  <div class="statistics-page">
    ...
    {:else if stats}
      ...
      <div class="workspace-navigation">
        <Tabs id="statistics-tabs" label="Statistics sections" items={sections} bind:value={activeSection} variant="underline" controls="statistics-panel" onchange={changeSection}/>
        <div class="scope-bar">
...
<style>
  .statistics-page{min-width:0;min-height:calc(100dvh - var(--utility-height));padding:14px 20px 0;container:statistics / inline-size;background:var(--document-bg)}
  ...
  .workspace-navigation{position:sticky;top:var(--utility-height);z-index:10;background:var(--document-bg);display:flex;align-items:center;flex-wrap:wrap;gap:0 14px;border-bottom:1px solid var(--border-primary)}.workspace-navigation :global(.tabs){flex:1 1 400px}.workspace-navigation :global(.tabs button){padding-inline:10px}.workspace-navigation :global(.tabs.underline){border-bottom:0}.scope-bar{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:6px 0;flex:1 1 300px;justify-content:flex-end}.scope-controls{min-width:0;display:flex;align-items:center;gap:12px}.scope-copy{min-width:0;color:var(--text-secondary);font-size:11px;line-height:1.5}.scope-controls>:global(button){flex:none}
  ...
  .overview-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));grid-auto-rows:1fr;gap:12px;align-items:stretch;margin-bottom:12px}
  ...
  @media(max-width:600px){.statistics-page{padding:12px 10px 0}.dataset-select{width:100%}.dataset-select>small{display:none}.dataset-select :global(.field){gap:3px}.dataset-summary{padding:8px 10px;grid-template-columns:repeat(3,minmax(0,1fr));margin-bottom:6px}.dataset-summary>div{display:flex;flex-direction:column;gap:2px;padding-inline:8px}.dataset-summary strong,.dataset-summary .sample-summary strong{font-size:20px}.dataset-summary strong small{font-size:11px}.dataset-summary span{font-size:9px}.dataset-summary .summary-label{font-size:9px}.scope-bar{padding:4px 0;gap:4px;justify-content:space-between}.scope-controls{gap:8px}.scope-copy{font-size:10px;max-height:42px;overflow:auto}.scope-bar>:global(button){font-size:10px;flex:none;padding-inline:6px}.content-area{padding-top:12px;scroll-margin-top:114px}.section-heading{margin-bottom:10px}.section-heading h2{font-size:18px}.section-heading p{font-size:11px}.distribution-controls{gap:6px}.distribution-controls>:global(.segments):first-child{width:100%}.distribution-controls :global(.segments button){flex:1;min-width:0;padding-inline:9px;font-size:12px}.stat-overview :global(.stats>div){min-height:48px}.stat-overview :global(dd){font-size:17px}.stat-overview :global(dt){font-size:8px}.workspace-navigation{gap:0}.workspace-navigation :global(.tabs button){padding-inline:9px;font-size:12px;gap:5px}.workspace-navigation :global(.tabs button svg){display:none}}
  @media(pointer:coarse){.profile-heading :global(button){min-height:var(--touch-target)}.distance-focus :global(.segments button),.distance-leader{min-height:var(--touch-target)}.type-filters :global(button){min-height:var(--touch-target)}.distribution-controls :global(.segments button){min-height:var(--touch-target)}}
</style>
