...
import type { CharacterStatistics, DistanceStatistics, GlobalStatistics, StatisticsDataset } from '../../domain/statistics/statistics-types';
import { QueryCache } from '../../platform/data/query-cache';
import { statisticsDistanceId } from '../../domain/statistics/statistics';
import { resourceRepository } from '../../catalog/resource-repository';
import { characterImagePath, type CharacterCatalogEntry, type CharacterNames } from '../../catalog/character-catalog';
import { loadLiveSupportCards, supportCardImagePath } from '../../catalog/support-card-catalog';
import { normalizeSkill, skillImage } from '../../catalog/skill-catalog';
import { supportTypeName } from '../../domain/supports/support-card';

export interface StatisticsCatalogEntry { id: string; title: string; tags: string[]; image?: string; detail?: string; }

export type { CharacterStatistics, DistributionItem, GlobalStatistics, MetricGroup, StatDistribution, StatisticsDataset, StatisticsScope } from '../../domain/statistics/statistics-types';
