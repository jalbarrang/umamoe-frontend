import type { ProfileVeteran, SuccessionChara } from '../../features/profile/profile-repository';
import type { InheritanceRecord } from '../inheritance/inheritance-search';
import { resolveVeteranFactors } from '../profile/profile-veterans';
import { totalStats } from '../profile/profile-display';
import { emptyPlannerNodes, calculatePlannerAffinity } from '../lineage/planner';
import type { VeteranAffinityEngine } from './affinity-engine';
import type { CharacterCatalogEntry } from '../../catalog/character-catalog';
