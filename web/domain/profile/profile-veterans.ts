import { decodeFactor, decodeFactorEntry, type FactorCategory } from '../../catalog/factor-catalog';
import { characterImagePath, type CharacterCatalogEntry } from '../../catalog/character-catalog';
import type { FactorInfoEntry, ProfileVeteran, SuccessionChara } from '../../features/profile/profile-repository';
